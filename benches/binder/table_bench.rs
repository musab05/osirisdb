...
fn setup_with_n_tables(n: usize) -> (CatalogManager, Symbol, Symbol, Symbol, Symbol) {
...
pub fn bench(c: &mut Criterion) {
    ...
    for n in [0usize, 10, 100, 1000] {
        let (m, db, schema, new_table, session) = setup_with_n_tables(n);
